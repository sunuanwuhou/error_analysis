...
- 只返回 JSON，不要任何额外说明`;
  const extraPathGuide = [
    ...
    '',
    '如果是5级，再把完整5级路径都返回：',
    '"knowledgePathTitles": ["1级","2级","3级","4级","5级"]',
    '"knowledgePath": "1级 > 2级 > 3级 > 4级 > 5级"',
    '"knowledgeNodePath": "1级 > 2级 > 3级 > 4级 > 5级"',
    '"notePath": "1级 > 2级 > 3级 > 4级 > 5级"',
    '',
    '兼容规则：',
    '- type = 1级',
    '- subtype = 2级',
    '- subSubtype = 最终叶子（3级/4级/5级）',
    '- 4级或5级题目，必须同时返回 knowledgePathTitles 等完整路径字段',
    '- 可额外返回 level4 / level5，便于编辑表单直接回填',
    '',
    '4级示例：',
    '{',
    '  "type": "判断推理",',
    ...
    '  "level4": "削弱",',
    '  "level5": "诉诸权威",',
    '  "knowledgePathTitles": ["判断推理","加强削弱","削弱","论证方式","诉诸权威"],',
    '  "knowledgePath": "判断推理 > 加强削弱 > 削弱 > 论证方式 > 诉诸权威"',
    '}'
  ].join('\n');
