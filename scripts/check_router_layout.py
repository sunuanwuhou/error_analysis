...
EXPECTED_ROUTES: dict[tuple[str, str], str] = {
    ...
    ('GET', '/api/backup/cloud'): 'app.routers.backup.get_cloud_backup',
    ...
    ('GET', '/api/knowledge/nodes/{node_id}'): 'app.routers.knowledge.get_knowledge_node',
    ('POST', '/api/knowledge/nodes'): 'app.routers.knowledge.create_knowledge_node',
    ('PUT', '/api/knowledge/nodes/{node_id}'): 'app.routers.knowledge.update_knowledge_node',
    ('GET', '/api/errors/{error_id}'): 'app.routers.errors.get_error',
    ('POST', '/api/errors'): 'app.routers.errors.create_error',
    ('PUT', '/api/errors/{error_id}'): 'app.routers.errors.update_error',
    ('DELETE', '/api/errors/{error_id}'): 'app.routers.errors.delete_error',
    ('PATCH', '/api/errors/{error_id}/mastery'): 'app.routers.errors.patch_error_mastery',
