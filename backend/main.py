...
from backend.routers import admin, ai, auth, backup, images, interview, knowledge, practice, shenlun, sync, suite_bank, web
...
def create_app() -> FastAPI:
    ...
    app.mount("/assets", StaticFiles(directory=str(LEGACY_XINGCE_DIR)), name="assets")
    ...
    for router_module in (web, auth, admin, backup, ai, images, sync, practice, knowledge, shenlun, suite_bank, interview):
