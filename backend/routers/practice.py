...
from backend.services.practice_log_service import read_recent_practice_logs, write_practice_log
from backend.services.practice_query_service import (
...
from backend.services.practice_write_service import write_practice_attempts
from backend.services.today_training_session_service import (
    get_today_session,
    pause_today_session,
