...
class SuitePracticeItemPayload(BaseModel):
    question_id: str = ""
    question_no: str = ""
...
class SuitePracticeRecordPayload(BaseModel):
    paper_id: str = Field(min_length=1, max_length=160)
    paper_title: str = ""
    paper_folder: str = ""
    mode: str = Field(default="exam", max_length=32)
    duration_sec: int = Field(default=0, ge=0, le=864_000)
    correct_count: int = Field(ge=0, le=9999)
    wrong_count: int = Field(ge=0, le=9999)
